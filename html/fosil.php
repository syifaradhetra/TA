...
$fosil = mysqli_query($conn, "SELECT * FROM tb_fosil ORDER BY id_fosil DESC");
                        ...
                        WHILE($row = mysqli_fetch_assoc($fosil)){
                          // var_dump($row); die;
                          $data[] = $row;
                          // var_dump($data);
                        }
...
<body>
  ...
  <header>
    ...
    <div class="page-banner bg-img bg-img-parallax overlay-dark"
      style="background-image: url(../assets/img/trinil.jpg);">
          ...
          <div class="col-lg-8">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-dark bg-transparent justify-content-center py-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Fosil</li>
              </ol>
            </nav>
            <h1 class="fg-white text-center">Fosil</h1>
          </div>
        </div>
      </div>
    </div> <!-- .page-banner -->
...
<div class="page-section">
  <div class="container">
    <div class="text-center">
      <div class="subhead">Beberapa Fosil</div>
      <h2 class="title-section">Fosil</h2>
    </div>
    ...
    <div class="owl-carousel team-carousel mt-5">
      ...
      <div class="team-wrap">
        ...
        <img src="../admin/terupload/<?= $data[$i]["foto_fosil"] ?>" alt="" style="width: 300px; height: 200px">
        </div>
        <div class="team-content">
          <h3><?= $data[$i]["nama_fosil"] ?></h3>
          <h6><?= $data[$i]["jenis_fosil"] ?></h6>
          <p><?= $data[$i]["sejarah_fosil"] ?></p>
